...
import { BuildingAssociativePositions, BuildingExistancyStatus, BuildingType, NumberedDropDownOptions, PrimaryUses } from 'src/app/core/constants';
...
export class EditBuildingModalComponent implements OnInit {
  ...
  updateExisting() {
    ...
    this.selectedAssociativePosition = this.buildingDetails.associativePosition;
  ...
  async create() {
    ...
    const result = await this.buildingDetailService.createBuildingDetail(this.buildingDetails).toPromise();
  ...
  async update() {
    ...
    const result = await this.buildingDetailService.updateBuildingDetail(this.buildingId,this.buildingDetails).toPromise();
